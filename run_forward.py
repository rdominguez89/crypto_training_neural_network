...
def run_forward_test(model, ct, timeframe, frac_be, limit_low_range, limit_top_range, shift_open, use_NY_trading_hour, use_day_month, method, prices_col_1, prices_col_2, period_lb, std_dev, multiplier, ratio, side, window, ma_periods, periods_look_back, cols_original, X_train, do_month=7):
